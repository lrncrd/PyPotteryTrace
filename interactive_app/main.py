...
def get_system_info():
    ...
    # Include backward-compatible flat fields for legacy callers
    gpu_names = info['gpu']['gpu_names']
    info['gpu_available'] = info['gpu']['cuda_available']
    info['gpu_count'] = info['gpu']['gpu_count']
    info['gpu_name'] = gpu_names[0] if gpu_names else None
    info['mps_available'] = info['mps']['mps_available']
    info['success'] = True
